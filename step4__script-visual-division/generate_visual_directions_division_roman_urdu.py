...
PROMPT_SCENE_BREAKDOWN = """You are a video script editor breaking a 
Roman Urdu Tafseer block into individual spoken scenes.
...
visual aids for a Roman Urdu Tafseer video.
