...
def main():
    ...
    api_key = (
        env.get("GEMINI_API_KEY_STEP2") or 
        env.get("GEMINI_API_KEY") or 
        os.environ.get("GEMINI_API_KEY_STEP2") or 
        os.environ.get("GEMINI_API_KEY")
    )
    
    if not api_key:
        print("Error: GEMINI_API_KEY_STEP2 or GEMINI_API_KEY not found in .env or environment variables.", file=sys.stderr)
        sys.exit(1)
